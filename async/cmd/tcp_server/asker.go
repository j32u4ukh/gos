...
func (m *Manager) AskerHandler(tcp *gtcp.TcpContext) error {
	...
	switch cmd {
	case 0:
		err = m.handleAskerSystemCommand(tcp)
		if err != nil {
...
func (m *Manager) handleAskerSystemCommand(tcp *gtcp.TcpContext) error {
